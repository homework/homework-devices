...
public class Convert
{
	...
	private static class FlowConverter implements Converter
	{
		...
		@Override
		public String convertLine(final String line)
		{
			return line.substring(0, 10) + " " + line.substring(11, 19) + "," + line.substring(20).replaceAll(":", ",");
		}

		@Override
		public Date getDate(final String line) throws ParseException
		{
		...
		@Override
		public boolean shouldConvertFile(final File file)
		{
	...
	// macAddress.substring(8,10) + ":" + macAddress.substring(10);
	//
	// String outline = timestamp + "," + macAddress +
