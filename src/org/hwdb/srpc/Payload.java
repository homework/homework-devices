...
public abstract class Payload
{
	...
	{
		final ByteBuffer out = ByteBuffer.allocate(COMMAND_SIZE);
		out.putInt(subport).putInt(seqNo).putShort((short) command.ordinal()).put((byte) fragment)
	...
	{
		return String.format(	"Payload - Subport: %d  SeqNo: %d Command: %s Fragment: %d FragCount: %d", subport,
								seqNo,
